//на входе последовательность целых попарно различных чисел.
// По ним строятся сбалансированное авл дерево.
// Удалить из дерева все вершины с четными номерами,после каждого удаления - ребалансировка
